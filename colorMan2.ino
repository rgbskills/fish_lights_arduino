...
#define MAX_BRIGHTNESS 255      // Thats full on, watch the power! 164
#define MIN_BRIGHTNESS 8       // set to a minimum of 25%

const int brightnessInPin = A0;  // The Analog input pin that the brightness control potentiometer is attached to.
const int colourInPin = A1;      // The Analog input pin that the colour control potentiometer is attached to.
